						...
						function ()
							{
									...
									if (p.sortname==$(pth).attr('abbr')&&p.sortname) 
									 ...
									 $(this).wrapInner("<span></span>").children().first().appendTo(tdDiv);
									// $(':checkbox',$(tdDiv)).checkbox();
					...
					(
						function ()
							...
							.click(function (e) 
								{ 
										if(tg.currRow){
											$(tg.currRow).removeClass('trSelected');
										}
			 	...
			 	function ()
					{
						...
						if ($(this).attr('abbr'))
						 ...
						 //thdiv.innerHTML = this.innerHTML+"ADASD";
						 $(this).wrapInner("<span></span>").children().first().appendTo(thdiv);
						 //$(':checkbox',$(thdiv)).checkbox();
							...
							.hover(
								function(){
									...
									if (g.colCopy) 
										...
										nl = onl - nw + Math.floor(p.cgwidth/2)-diff;
